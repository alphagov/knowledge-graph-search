describe('Infobox results', () => {
  ...
  //   cy.visit('?selected-words=%22Chancellor+of+the+Exchequer%22&search-in-text=false')
  ...
  it('Shows the Taxon infobox', () => {
    cy.visit('?selected-words=%22Access+to+the+countryside%22&search-in-text=false')
  ...
  it('Shows the Transaction infobox', () => {
    ...
    cy.contains('div.meta-results-panel h2', 'Accept a refugee integration loan');
