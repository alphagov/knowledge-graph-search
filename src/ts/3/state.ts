...
const state: State = {
  ...
  publishingApps: [], // list of all publishing apps
  documentTypes: [],
  ...
  pages: Pages.All,
  showHeaders: sessionStorage?.showHeaders ? JSON.parse(sessionStorage?.showHeaders) : false,
  showFilters: sessionStorage?.showFilters ? JSON.parse(sessionStorage?.showFilters) : true
};
...
const setQueryParamsFromQS = function(): void {
  ...
  state.searchParams.selectedDocumentType = maybeReplace('selectedDocumentType', 'selected-documentType');
...
const searchState = function(): { code: string, errors: string[] } {
  ...
  if (state.searchParams.selectedWords === '' && state.searchParams.excludedWords === '' && state.searchParams.selectedTaxon === '' && state.searchParams.selectedOrganisation === '' && state.searchParams.selectedDocumentType === '' && state.searchParams.selectedLocale === '' && state.searchParams.linkSearchUrl === '') {
...
export { state, setQueryParamsFromQS, searchState, resetSearch, initialSearchParams, clearFilters };
