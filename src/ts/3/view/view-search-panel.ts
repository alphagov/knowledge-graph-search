...
<div class="govuk-form-group">
 <fieldset
   ...
   <div class="govuk-radios__item">
     ...
     <label for="whereToSearch" class="govuk-label govuk-radios__label">
       Title
     </label>
   </div>
    ...
    <fieldset
      ...
      <div class="govuk-radios" id="site-areas">
        <div class="govuk-radios__item">
          ...
          <label for="area" class="govuk-label govuk-radios__label">
            Publisher
          </label>
        </div>
        <div class="govuk-radios__item">
          ...
          <label for="area" class="govuk-label govuk-radios__label">Whitehall</label>
        </div>
        <div class="govuk-radios__item">
          <input class="govuk-radios__input"
          ...
          <label for="area" class="govuk-label govuk-radios__label">All publishing applications</label>
        </div>
      </div>
    </fieldset>
  </div>
